%% K_QUADRATICMODEL_CALCULATOR This function calculates the effective thermal conductivities of n materials with their volume fractions,
% which is the quadratic mean of all thermal conductivities.

function keff = k_quadraticModel_calculator(thermalConductivitiesMatrix,volumeFractionsMatrix,thermalConductivityFiller,porosity) 
...
%% calculate the thermal conductivity
    ...
    keff =	sqrt(sum(volumeFractions .* thermalConductivities.^2));