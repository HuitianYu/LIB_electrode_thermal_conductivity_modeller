%% K_PARALLELMODEL This function calculates the effective thermal conductivity of n materials with their volume fractions,
% which is organized in parallel.


function keff = k_parallelModel(namesMatrix,volumeFractionsMatrix,nameFiller,porosity)
