%% K_GEOMETRICMODEL This function calculates the effective thermal conductivity for one electrode,
% which is the geometric mean of thermal conductivities.

function keff = k_geometricModel_calculator(thermalConductivitiesMatrix,volumeFractionsMatrix,thermalConductivityFiller,porosity) 
...
%% calculate the thermal conductivity
    ...
    keff =	prod(thermalConductivities .^ volumeFractions);