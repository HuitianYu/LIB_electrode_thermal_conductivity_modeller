%% K_GEOMETRICMODEL This function calculates the effective thermal conductivity of n materials with their volume fractions,
% which is the geometric mean of thermal conductivities.

function keff = k_geometricModel(namesMatrix,volumeFractionsMatrix,nameFiller,porosity)
