%% K_SERIESMODEL_CALCULATOR This function calculates the effective thermal conductivities of n materials with their volume fractions,
% which is organized in series.

function keff = k_seriesModel_calculator(thermalConductivitiesMatrix,volumeFractionsMatrix,thermalConductivityFiller,porosity) 
...
%% calculate the thermal conductivity
    ...
    keff = 1/sum(volumeFractions ./ thermalConductivities);