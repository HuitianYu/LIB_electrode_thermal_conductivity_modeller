%% K_SERIESMODEL This function calculates the effective thermal conductivity of n materials with their volume fractions,
% which is organized in series.

function keff = k_seriesModel(namesMatrix,volumeFractionsMatrix,nameFiller,porosity) 
