%% K_RNM_1_ELECTRODE This function calculates the effective thermal conductivity for one electrode,
% which is organized by RNM 1.

function keff = k_RNM_1_electrode(nameElectrode,nameFiller,modeTortuosity,a) 
