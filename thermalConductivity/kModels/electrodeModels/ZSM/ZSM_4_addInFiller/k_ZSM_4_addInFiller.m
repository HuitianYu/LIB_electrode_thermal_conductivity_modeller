%% K_ZSM_4_ADDINFILLER This model calculates the effective thermal conductivity using names from table statistics
% according to ZSM_4_addInFiller.

function keff = k_ZSM_4_addInFiller(namesMatrix,volumeFractionsMatrix,nameFiller,porosity,curveName,modelAdditiveName,modeTortuosity,alpha,c,e,g,modelAddInFillerName)
