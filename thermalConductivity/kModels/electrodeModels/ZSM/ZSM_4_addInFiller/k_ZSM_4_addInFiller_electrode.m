%% K_ZSM_4_ADDINFILLER_ELECTRODE This model calculates the effective thermal conductivity using electrode information from table electrode
% according to ZSM_4_addInFiller.

function keff = k_ZSM_4_addInFiller_electrode(nameElectrode,nameFiller,curveName,modelAdditiveName,modeTortuosity,alpha,c,e,g,modelAddInFillerName)
...
%% Calculation of the effective thermal conductivity
	...
	modelNamesParameters ='ZSM_4_addInFiller';
