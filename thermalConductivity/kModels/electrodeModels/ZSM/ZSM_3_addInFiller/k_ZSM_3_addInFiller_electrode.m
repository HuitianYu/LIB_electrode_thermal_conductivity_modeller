%% K_ZSM_3_ADDINFILLER_ELECTRODE This model calculates the effective thermal conductivity using electrode information from table electrode
% according to ZSM_3_addInFiller.

function keff = k_ZSM_3_addInFiller_electrode(nameElectrode,nameFiller,curveName,modelAdditiveName,modeTortuosity,alpha,c,e,g,modelAddInFillerName)
...
%% Calculation of the effective thermal conductivity
	...
	modelNamesParameters ='ZSM_3_addInFiller';
