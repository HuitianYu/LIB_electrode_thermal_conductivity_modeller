%% K_ZSM_4_ELECTRODE This model calculates the effective thermal conductivity using electrode information from table electrode
% according to ZSM_4.

function keff = k_ZSM_4_electrode(nameElectrode,nameFiller,curveName,modelAdditiveName,modeTortuosity,a,c,e,g)
