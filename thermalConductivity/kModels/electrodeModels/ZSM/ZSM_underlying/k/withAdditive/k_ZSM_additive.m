%% K_ZSM_ADDITIVE This function calculates the effective thermal conductivity with additive
% via the radius of additive RAdd, using Zehner Schlunder model.
% Here, phi is used to determine B iteratively.

function keff = k_ZSM_additive(nameMatrix,nameFiller,nameAdditive,curveName,R,alpha,phi,RAdditive)
%% Explanations of input & output arguments:
    ...
    % RAdditive: e.g. 0.25: numeric variable for additive. RAdditive is in range of [0,1]   
...
%% To calculate the effective thermal conductivity
    ...
    keff = k_ZSM_additive_calculator(k_matrix,k_filler,k_additive,curveName,R,B,alpha,RAdditive);
