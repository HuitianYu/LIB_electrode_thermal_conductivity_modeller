%% K_ZSM_2_ELECTRODE This function calculates the effective thermal conductivity for one electrode,
% which is organized by ZSM modification 4.
% e: e.g. 0.1: numeric variable in range of [0,1].

function keff = k_ZSM_2_electrode(nameElectrode,nameFiller,curveName,modelAdditiveName,modeTortuosity,alpha,c,e,g) 
...
%% calculate the thermal conductivity
    ...
    elseif isnumeric(c)
        keff = k_model_out_of_name_electrode(   nameElectrode,nameFiller,...
                                                ['ZSM_2,curveName=''',curveName,''',modelAdditiveName=''',modelAdditiveName,...
                                                ''',modeTortuosity=',num2str(modeTortuosity),',a=',num2str(alpha),',c=',num2str(c),',e=',num2str(e),',g=',num2str(g)]);
    end
