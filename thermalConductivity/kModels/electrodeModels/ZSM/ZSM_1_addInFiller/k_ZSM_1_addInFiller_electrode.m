%% K_ZSM_1_ADDINFILLER_ELECTRODE This model calculates the effective thermal conductivity using electrode information from table electrode
% according to ZSM_1_addInFiller.

function keff = k_ZSM_1_addInFiller_electrode(nameElectrode,nameFiller,curveName,modelAdditiveName,modeTortuosity,a,c,e,g,modelAddInFillerName)
...
%% Calculation of the effective thermal conductivity
	...
	modelNamesParameters ='ZSM_1_addInFiller';
