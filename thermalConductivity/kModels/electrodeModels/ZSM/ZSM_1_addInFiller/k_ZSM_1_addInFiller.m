%% K_ZSM_1_ADDINFILLER This model calculates the effective thermal conductivity using names from table statistics
% according to ZSM_1_addInFiller.

function keff = k_ZSM_1_addInFiller(namesMatrix,volumeFractionsMatrix,nameFiller,porosity,curveName,modelAdditiveName,modeTortuosity,a,c,e,g,modelAddInFillerName)
