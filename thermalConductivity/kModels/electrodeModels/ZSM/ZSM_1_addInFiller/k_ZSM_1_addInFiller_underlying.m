%% K_ZSM_1_ADDINFILLER_UNDERLYING This function calculates the effective thermal conductivity of active material, conductive additve, binder filled with filler.
...
% with varying model for additive system in filler (fluid).

function [deviation_vFr_matrixPassage,keff] = k_ZSM_1_addInFiller_underlying(thermalConductivitiesMatrix,volumeFractionsMatrix,thermalConductivityFiller,allPorosity,curveName,modelAdditiveName,modeTortuosity,a,c,e,g,modelAddInFillerName)
