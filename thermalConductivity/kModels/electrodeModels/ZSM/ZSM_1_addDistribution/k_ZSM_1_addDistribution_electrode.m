%% K_ZSM_1_ADDDISTRIBUTION_ELECTRODE This model calculates the effective thermal conductivity using electrode information from table electrode
% according to ZSM_1_addDistribution.

function keff = k_ZSM_1_addDistribution_electrode(nameElectrode,nameFiller,curveName,modelAdditiveName,modeTortuosity,a,c,e,g,addDistribution,addDisPar)
