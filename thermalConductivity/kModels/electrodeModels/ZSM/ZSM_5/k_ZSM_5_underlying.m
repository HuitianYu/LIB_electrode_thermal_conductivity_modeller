%% K_ZSM_5_UNDERLYING This function calculates the effective thermal conductivity of active material, conductive additve, binder filled with filler.
...
function [deviation_vFr_matrixPassage,keff] = k_ZSM_5_underlying(thermalConductivitiesMatrix,volumeFractionsMatrix,thermalConductivityFiller,allPorosity,curveName,modelAdditiveName,modeTortuosity,a,c)
...
%% Calculation of effective thermal conductivity
    ...
    k_dispersed = k_model_out_of_name_calculator([k_additive_pure;k_filler],vFrDispersed_additive_real,'none',0,'EMT,f=6');
