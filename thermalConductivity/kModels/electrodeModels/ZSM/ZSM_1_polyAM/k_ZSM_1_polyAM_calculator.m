%% K_ZSM_1_polyAM_CALCULATOR This function calculates the effective thermal conductivity of active material (2 kinds), conductive additve, binder filled with filler.
...
function keff = k_ZSM_1_polyAM_calculator(thermalConductivitiesMatrix,volumeFractionsMatrix,thermalConductivityFiller,porosity,curveName,modelAdditiveName,modeTortuosity,a,c,e,g,volumeFractionsAM)
...
%% Calculation of effective thermal conductivity
    ...
    for ii = 1 : n_AM
        ...
        keff_PolyAM(ii,1) = k_ZSM_1_calculator(thermalConductivitiesMatrix_temp,volumeFractionsMatrix,thermalConductivityFiller,porosity,curveName,modelAdditiveName,modeTortuosity,a,c,e,g);
    end
    clear ii
