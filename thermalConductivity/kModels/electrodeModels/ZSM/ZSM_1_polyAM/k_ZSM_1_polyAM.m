%% K_ZSM_1_POLYAM This model calculates the effective thermal conductivity using names from table statistics
% according to ZSM_1_polyAM.

function keff = k_ZSM_1_polyAM(namesMatrix,volumeFractionsMatrix,nameFiller,porosity,curveName,modelAdditiveName,modeTortuosity,a,c,e,g,volumeFractionsAM)
...
%% Calculation of the effective thermal conductivity
	...
	modelNamesParameters ='ZSM_1_polyAM';
