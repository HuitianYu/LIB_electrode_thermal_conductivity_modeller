%% K_ZSM_1_a_ADDDISTRIBUTION_CALCULATOR This function calculates the effective thermal conductivity of active material, conductive additve, binder filled with filler,
...
function keff = k_ZSM_1_a_addDistribution_calculator(thermalConductivitiesMatrix,volumeFractionsMatrix,thermalConductivityFiller,porosity,curveName,modelAdditiveName,modeTortuosity,a,c,e,g,addDistribution,addDisPar)
...
%% Calculation of effective thermal conductivity
   ...
   for ii = 1 : size(x_avg,1)
       ...
       keff_layers(ii,1) = k_ZSM_1_a_calculator(thermalConductivitiesMatrix,vFr_matrix_tmp,thermalConductivityFiller,vFr_porosity(ii,1),curveName,modelAdditiveName,modeTortuosity,a,c,e,g);
   end
   clear ii
