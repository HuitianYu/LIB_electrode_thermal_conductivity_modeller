%% K_ZSM_2_ADDINFILLER_ELECTRODE This model calculates the effective thermal conductivity using electrode information from table electrode
% according to ZSM_2_addInFiller.

function keff = k_ZSM_2_addInFiller_electrode(nameElectrode,nameFiller,curveName,modelAdditiveName,modeTortuosity,alpha,c,e,g,modelAddInFillerName)
